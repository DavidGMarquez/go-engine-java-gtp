...
import prolog.go.CEU.TraductorGTPProlog;
...
/** Dummy Go program for testing GTP controlling programs.
    ...
    commands. */
public class DummyCEU
    extends GtpEngine
{
    TraductorGTPProlog traductorGTPProlog=new TraductorGTPProlog("prolog/goRules.pl", 9);
    public DummyCEU(PrintStream log, boolean useRandomSeed, long randomSeed,
                 int resign)
        throws Exception
    {
        super(log);
    ...
    public void cmdBoardsize(GtpCommand cmd) throws GtpError
    {
        ...
        initSize(size);
        traductorGTPProlog.boardSize(size);
    }

    public void cmdCrash(GtpCommand cmd)
    {
        System.err.println("Aborting gogui-CEU");
        System.exit(1);
    }
    ...
    public void cmdGenmove(GtpCommand cmd) throws GtpError
    {
        ...
        point=traductorGTPProlog.genMove(color);
        //si point es nulo se hace un pass
    ...
    public void cmdPlay(GtpCommand cmd) throws GtpError
    {
        ...
        traductorGTPProlog.addPiece(point,color);
        /*if (point != null)
            m_alreadyPlayed[point.getX()][point.getY()] = true;*/
    }
