...
:- assert(isInSquare(0, black(1), 2, 2)).
:- assert(isInSquare(0, black(2), 3, 1)).
:- assert(isInSquare(0, black(3), 3, 3)).
:- assert(isInSquare(0, black(4), 4, 2)).

:- assert(isInSquare(0, white(1), 2, 3)).
:- assert(isInSquare(0, white(2), 3, 4)).
:- assert(isInSquare(0, white(3), 4, 3)).


:- assert(hasPlayerWithTheMove(0,white)).
:- assert(hasNumberMoves(0,black,4)).
